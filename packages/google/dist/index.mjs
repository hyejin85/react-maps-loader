...
const re = (e) => new google.maps.LatLng(e.lat, e.lng);
class Fe {
  /**
   * @constructor
  ...
  makeMarkers(t) {
    if (this.markers.forEach((r) => r.setMap(null)), this.markers = [], t.length !== 0) {
      if (t.length <= 1) {
        const [r] = t, a = re(r.position);
        this.setCenter(a);
      } else
        this.setBounds();
      t.forEach((r) => {
        const a = re(r.position);
...
const He = Fe;
var we = typeof global == "object" && global && global.Object === Object && global, Ze = typeof self == "object" && self && self.Object === Object && self, v = we || Ze || Function("return this")(), S = v.Symbol, Ae = Object.prototype, Ne = Ae.hasOwnProperty, Ue = Ae.toString, x = S ? S.toStringTag : void 0;
function Ke(e) {
  var t = Ne.call(e, x), r = e[x];
  try {
    e[x] = void 0;
    var a = !0;
  } catch {
...
var Xe = "[object Null]", Je = "[object Undefined]", ae = S ? S.toStringTag : void 0;
function B(e) {
  return e == null ? e === void 0 ? Je : Xe : ae && ae in Object(e) ? Ke(e) : qe(e);
}
function L(e) {
...
var O = v["__core-js_shared__"], ne = function() {
...
var Y = E(v, "WeakMap"), gt = 9007199254740991, lt = /^(?:0|[1-9]\d*)$/;
function dt(e, t) {
  var r = typeof e;
...
var Se = Object.prototype, Tt = Se.hasOwnProperty, wt = Se.propertyIsEnumerable, At = se(/* @__PURE__ */ function() {
  return arguments;
}()) ? se : function(e) {
...
var Ee = typeof exports == "object" && exports && !exports.nodeType && exports, ie = Ee && typeof module == "object" && module && !module.nodeType && module, jt = ie && ie.exports === Ee, oe = jt ? v.Buffer : void 0, Pt = oe ? oe.isBuffer : void 0, Q = Pt || $t, Ct = "[object Arguments]", St = "[object Array]", Et = "[object Boolean]", xt = "[object Date]", Mt = "[object Error]", Lt = "[object Function]", It = "[object Map]", Rt = "[object Number]", Bt = "[object Object]", zt = "[object RegExp]", Dt = "[object Set]", Gt = "[object String]", Ft = "[object WeakMap]", Ht = "[object ArrayBuffer]", Zt = "[object DataView]", Nt = "[object Float32Array]", Ut = "[object Float64Array]", Kt = "[object Int8Array]", Ot = "[object Int16Array]", Wt = "[object Int32Array]", qt = "[object Uint8Array]", Xt = "[object Uint8ClampedArray]", Jt = "[object Uint16Array]", Yt = "[object Uint32Array]", f = {};
f[Nt] = f[Ut] = f[Kt] = f[Ot] = f[Wt] = f[qt] = f[Xt] = f[Jt] = f[Yt] = !0;
f[Ct] = f[St] = f[Ht] = f[Et] = f[Zt] = f[xt] = f[Mt] = f[Lt] = f[It] = f[Rt] = f[Bt] = f[zt] = f[Dt] = f[Gt] = f[Ft] = !1;
function Qt(e) {
...
var xe = typeof exports == "object" && exports && !exports.nodeType && exports, M = xe && typeof module == "object" && module && !module.nodeType && module, kt = M && M.exports === xe, W = kt && we.process, ue = function() {
  try {
    var e = M && M.require && M.require("util").types;
    return e || W && W.binding && W.binding("util");
  } catch {
  }
}(), fe = ue && ue.isTypedArray, Me = fe ? Vt(fe) : Qt, er = Object.prototype, tr = er.hasOwnProperty;
function rr(e, t) {
  var r = H(e), a = !r && At(e), s = !r && !a && Q(e), n = !r && !a && !s && Me(e), i = r || a || s || n, p = i ? vt(e.length, String) : [], o = p.length;
  for (var u in e)
...
var Nr = Object.prototype, Ur = Nr.propertyIsEnumerable, pe = Object.getOwnPropertySymbols, Kr = pe ? function(e) {
  return e == null ? [] : (e = Object(e), Hr(pe(e), function(t) {
    return Ur.call(e, t);
  }));
} : Zr;
function Or(e, t, r) {
...
var V = E(v, "DataView"), k = E(v, "Promise"), ee = E(v, "Set"), ge = "[object Map]", Wr = "[object Object]", le = "[object Promise]", de = "[object Set]", he = "[object WeakMap]", me = "[object DataView]", qr = j(V), Xr = j(R), Jr = j(k), Yr = j(ee), Qr = j(Y), T = B;
(V && T(new V(new ArrayBuffer(1))) != me || R && T(new R()) != ge || k && T(k.resolve()) != le || ee && T(new ee()) != de || Y && T(new Y()) != he) && (T = function(e) {
...
var _e = v.Uint8Array, Vr = "__lodash_hash_undefined__";
function kr(e) {
...
Z.prototype.add = Z.prototype.push = kr;
Z.prototype.has = ea;
function ta(e, t) {
...
function Le(e, t, r, a, s, n) {
  ...
  if (u && l)
    return u == t && l == e;
  var d = -1, c = !0, _ = r & na ? new Z() : void 0;
  for (n.set(e, t), n.set(t, e); ++d < p; ) {
    ...
    if (_) {
      if (!ta(t, function(y, A) {
        if (!ra(_, A) && (h === y || s(h, y, r, a, n)))
          return _.push(A);
      })) {
        c = !1;
        break;
...
var oa = 1, ua = 2, fa = "[object Boolean]", pa = "[object Date]", ca = "[object Error]", ga = "[object Map]", la = "[object Number]", da = "[object RegExp]", ha = "[object Set]", ma = "[object String]", _a = "[object Symbol]", ya = "[object ArrayBuffer]", va = "[object DataView]", ye = S ? S.prototype : void 0, q = ye ? ye.valueOf : void 0;
...
function $a(e, t, r, a, s, n) {
  var i = r & Ta, p = ce(e), o = p.length, u = ce(t), l = u.length;
  if (o != l && !i)
    return !1;
  for (var d = o; d--; ) {
    var c = p[d];
...
var ja = 1, ve = "[object Arguments]", be = "[object Array]", G = "[object Object]", Pa = Object.prototype, Te = Pa.hasOwnProperty;
function Ca(e, t, r, a, s, n) {
  var i = H(e), p = H(t), o = i ? be : T(e), u = p ? be : T(t);
  ...
  if (!(r & ja)) {
    var _ = l && Te.call(e, "__wrapped__"), h = d && Te.call(t, "__wrapped__");
    if (_ || h) {
...
const xa = ({ apiKey: e, isGoogle: t, initMap: r, children: a }) => {
  ...
  const i = De(null), p = e === "google", [o, u] = K(), [l, d] = K(a), [c, _] = K(), h = Ge(() => {
    ...
    if (!g)
      return;
    let y;
    p ? y = new He(g, r) : y = new Ea(g, r), u(y);
  }, []), m = (g) => {
    _(g), n && n(g);
  };
  return F(() => {
